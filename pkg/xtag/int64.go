...
// int64Spec defines the [nomix.KindSpec] for [Int64] type.
var int64Spec = nomix.NewKindSpec(
	nomix.KindInt64,
	nomix.TagCreateFunc(CreateInt64),
	nomix.TagParseFunc(ParseInt64),
)

// Int64Spec returns a [nomix.KindSpec] for [Int64] type.
func Int64Spec() nomix.KindSpec { return int64Spec }
